...
public partial class SanBong
{
    ...
    public int ThoiGianGiuCho { get; set; } = 15;
    public int ThoiGianHuyTruocGioDa { get; set; } = 120;
    public decimal PhanTramHoanCocDungHan { get; set; } = 1.00m;
    public decimal PhanTramHoanCocTreHan { get; set; } = 0.00m;
